...
public extension ContextRef {
    ...
    public init<S: SurfaceProtocol>(surface: S) {
...
public extension Context {
    /// Create a Cairo context from a surface
    public convenience init<S: SurfaceProtocol>(surface: S) {
...
public extension ContextProtocol {
    ...
    /// See ref().
    public func unref() { cairo_destroy(ptr) }
    ...
    public var status: cairo_status_t { return cairo_status(ptr) }
    ...
    public func pushGroup() { cairo_push_group(ptr) }
    ...
    public func pushGroup(content: Content) {
    ...
    @discardableResult
    public func popGroup() -> PatternRef {
    ...
    public var groupTarget: SurfaceRef {
    ...
    public func setDash(_ dashes: [Double], offset: Double = 0.0) {
    ...
    ///
    /// The default operator is CAIRO_OPERATOR_OVER.
    public var compositingOperator: cairo_operator_t {
        get { return cairo_get_operator(ptr) }
        set { cairo_set_operator(ptr, newValue) }
    }
    ...
    public func clip() { cairo_clip(ptr) }
    ...
    public func clipPreserve() { cairo_clip_preserve(ptr) }
    ...
    public func isInClip(_ x: Double, _ y: Double) -> Bool {
    ...
    public func resetClip() { cairo_reset_clip(ptr) }

    /// Current clip region as a list of rectangles in user coordinates.
    public var clipRectangleList: [cairo_rectangle_t]? {
    ...
    public func fill() { cairo_fill(ptr) }
    ...
    public func fillPreserve() { cairo_fill_preserve(ptr) }
    ...
    var fillExtents: (x1: Double, y1: Double, x2: Double, y2: Double) {
        var x1: Double = 0.0
        var y1: Double = 0.0
        var x2: Double = 0.0
        var y2: Double = 0.0
    ...
    ///
    /// See fill(), fillRule, and fillPreserve().
    public func isInFill(_ x: Double, _ y: Double) -> Bool {
    ...
    public func mask<P: PatternProtocol>(pattern: P) { cairo_mask(ptr, pattern.ptr) }
    ...
    public func mask<S: SurfaceProtocol>(surface: S, x: Double = 0.0, y: Double = 0.0) {
    ...
    public func paint() { cairo_paint(ptr) }
    ...
    public func paint(alpha: Double) { cairo_paint_with_alpha(ptr, alpha) }
    ...
    public func stroke() { cairo_stroke(ptr) }
    ...
    public func strokePreserve() { cairo_stroke_preserve(ptr) }
    ...
    var strokeExtents: (x1: Double, y1: Double, x2: Double, y2: Double) {
        var x1: Double = 0.0
        var y1: Double = 0.0
        var x2: Double = 0.0
        var y2: Double = 0.0
    ...
    ///
    /// See stroke(), lineWidth, lineJoin, lineCap, dash, setDash(), and strokePreserve().
    public func isInStroke(_ x: Double, _ y: Double) -> Bool {
    ...
    public func copyPage() { cairo_copy_page(ptr) }
    ...
    public func showPage() { cairo_show_page(ptr) }
    ...
    public func userData(key: UnsafePointer<cairo_user_data_key_t>) -> UnsafeMutableRawPointer {
    ...
    @discardableResult
    public func setUserData(key: UnsafePointer<cairo_user_data_key_t>, value: UnsafeMutableRawPointer, destroy: cairo_destroy_func_t! = nil) -> cairo_status_t {
    ...
    public func newPath() { cairo_new_path(ptr) }
    ...
    public var path: PathRef { return PathRef(cairo_copy_path(ptr)) }
    ...
    public func append<P: PathProtocol>(path: P) {
    ...
    public var hasCurrentPoint: Bool {
    ...
    public func newSubPath() { cairo_new_sub_path(ptr) }
    ...
    public func curveTo(x1: Double, y1: Double, x2: Double, y2: Double, x3: Double, y3: Double) {
    ...
    public func lineTo(_ x: Double, _ y: Double) { cairo_line_to(ptr, x, y) }
    ...
    public func moveTo(_ x: Double, _ y: Double) { cairo_move_to(ptr, x, y) }
    ...
    public func glyphPath(glyphs: [cairo_glyph_t]) {
    ...
    public func relCurveTo(dx1: Double, dy1: Double, dx2: Double, dy2: Double, dx3: Double, dy3: Double) {
    ...
    public func relLineTo(_ dx: Double, _ dy: Double) {
    ...
    ///   - x: the X coordinate of the end of the new position
    ///   - y: the Y coordinate of the end of the new position
    public func relMoveTo(_ dx: Double, _ dy: Double) {
    ...
    var pathExtents: (x1: Double, y1: Double, x2: Double, y2: Double) {
        var x1: Double = 0.0
        var y1: Double = 0.0
        var x2: Double = 0.0
        var y2: Double = 0.0
